...
argParser.add_argument("-csv", "--csv_report", required=False, type=str, metavar=".\Report.csv", dest="outFilePath",
	help="Path to CSV report output file, including extension (autogenerated in script directory by default).")
...
argParser.add_argument("-ew", "--empty_val", required=False, type=str, default="N/A", metavar="\"N/A\"", dest="reportEmptyValue",
	help="Empty value representation (default is \"N/A\").")
